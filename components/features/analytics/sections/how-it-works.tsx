...
import { Activity, TrendingUp, Timer, MessageSquare, MapPin, Share2, FileSpreadsheet } from "lucide-react";
...
const copy = {
  title: "How it works",
  subtitle: "Monitor performance, discover opportunities, and prove ROI—all from conversation data.",
  methods: [
    {
      title: "Monitor high‑level performance",
      description: "Track engagement, trends, and operational ROI at a glance.",
      icon: Activity,
      features: [
        { title: "Quantify engagement", description: "Total Conversations and Messages over time.", icon: MessageSquare, videoSrc: "/features/add-sitemap.mp4" },
        { title: "Visualize trends", description: "See trending activity and correlate with campaigns.", icon: TrendingUp, videoSrc: "/features/single-url.mp4" },
        { title: "Minutes saved", description: "Estimate working minutes saved by your teammate.", icon: Timer, videoSrc: "/features/toggle-data-source.mp4" },
      ]
    },
    {
      title: "Discover strategic insights",
      description: "Reveal top questions and emerging topics to guide strategy.",
      icon: TrendingUp,
      features: [
        { title: "Top questions", description: "See what visitors ask most.", icon: MessageSquare, videoSrc: "/features/qa-pairs.mp4" },
        { title: "Emerging topics", description: "Spot new themes as they appear.", icon: TrendingUp, videoSrc: "/features/text-sources.mp4" },
      ]
    },
    {
      title: "Uncover actionable details",
      description: "Drill into geography and link pathways to understand context.",
      icon: MapPin,
      features: [
        { title: "By location", description: "Click a city to see all related conversations.", icon: MapPin, videoSrc: "/features/file-upload.mp4" },
        { title: "Link pathways", description: "Jump from a link to the originating message.", icon: Share2, videoSrc: "/features/creating-embedding.mp4" },
      ]
    },
    {
      title: "Prove your ROI",
      description: "Centralize leads and attribute outcomes to specific chats.",
      icon: FileSpreadsheet,
      features: [
        { title: "Lead & support logs", description: "Filterable, clean records for analysis.", icon: FileSpreadsheet, videoSrc: "/features/file-upload.mp4" },
      ]
    },
  ],
} satisfies Copy;
