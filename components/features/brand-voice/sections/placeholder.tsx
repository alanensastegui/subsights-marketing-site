...
export const sectionId = "brand-placeholder";

// ---- SECTION COPY REGION ----
const copy = {
  title: "Brand & voice",
  description: "This feature page is coming soon. We're working on creating an amazing brand and voice customization experience for you.",
