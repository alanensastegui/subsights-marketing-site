        ...
        <div className="animate-item">
          <ButtonDuo
            ...
            primary={{
              ...
              dataAttributes: {
                "data-analytics-id": "brand_voice_hero_demo",
                "data-analytics-name": "Email My Demo (Brand Voice Hero)",
                "data-analytics-context": '{"source":"brand_voice_hero","section":"hero"}',
              },
            }}
            secondary={{
              asChild: true,
              ...
              dataAttributes: {
                "data-analytics-id": "brand_voice_hero_start_free",
                "data-analytics-name": "Start Free Trial (Brand Voice Hero)",
                "data-analytics-context": '{"source":"brand_voice_hero","section":"hero"}',
              },
            }}
          />
