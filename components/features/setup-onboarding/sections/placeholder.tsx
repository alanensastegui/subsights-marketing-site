...
export const sectionId = "setup-placeholder";

// ---- SECTION COPY REGION ----
const copy = {
  title: "Effortless Setup & Onboarding",
  description: "This feature page is coming soon. We're working on creating an amazing setup and onboarding experience for you.",
