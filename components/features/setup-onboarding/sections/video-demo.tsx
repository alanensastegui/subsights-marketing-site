...
const copy = {
  ...
  subtitle: "Purpose-built to take you from sign-up to a live AI teammate—no noise, no headaches. Setup that gets out of your way so you can get back to work. ",
  videoId: "iicp8Ydxrnk",
} satisfies Copy;
// ---- /SECTION COPY REGION ----
